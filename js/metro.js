...
const botonTest = document.querySelector('.btn');

//---
// Funciones
//---

function setearBpmIdCancion(BPM) {
    console.log("Play BPM: ", BPM)
...
/* Evento Setear Squadron */
function eventoSetearBpm(event) {
    intervalo = reproducirOPausar(100, audioMetronomo, reproduciendo, intervalo);
    renderizarCambios(PPM, reproduciendo);
}
...
botonTest.addEventListener('click', eventoSetearBpm);
